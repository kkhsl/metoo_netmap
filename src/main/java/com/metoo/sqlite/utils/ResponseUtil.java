...
public class ResponseUtil {
    ...
    public static Result resourceNotFound() { return fail(400, "not found");} //未找到指定资源
    ...
    public static Result dataNotFound() { return new Result(1, "Data Not Found");}

    public static Result badArgument(String message) { return fail(400, message);} //未找到指定资源

    public static Result saveError() { return fail(500, "保存失败");}

    public static Result deleteError() { return fail(500, "删除失败");}

    public static Result badArgumentRepeatedName() { return fail(400, "名称重复");} //未找到指定资源

    public static Result badArgument(int code, String message) { return fail(code, message);}
    ...
    public static Result error() { return new Result(500, "系统错误");  }
    ...
    public static Result okMsg(String msg){return new Result(200, msg);}
    ...
    public static Result result(Result result){return result; }

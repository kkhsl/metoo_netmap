...
//@RestController
//public class Gather9ManagerController {
//
...
//
//    @Autowired
//    public Gather9ManagerController(ApiService apiService) {
...
//
//            String endTime = DateTools.getCreateTime();
//            this.careateSureyingLog("ipv4网段分析", endTime, 2);
//
//        } catch (Exception e) {
//            e.printStackTrace();
//
//            String endTime = DateTools.getCreateTime();
//            this.careateSureyingLog("ipv4网段分析", endTime, 3);
//        }
//    }
//
...
////                if(arps.size() >= 500){
////                    int batchSize = 100;
////                    int totalSize = arps.size();
////                    try {
////                        for (int i = 0; i < totalSize; i += batchSize) {
////                            int end = Math.min(totalSize, i + batchSize);
////                            List<Arp> subList = arps.subList(i, end);
////                            // 处理数据
////                            // 提取ARP对象列表中的IP地址
////                            List<String> ipAddresses = subList.stream()

...
@Component
@Slf4j
public class VersionStatusUpdateRemote extends BaseCall {
    /**
     * 版本更新检测url
     */
    @Value("${version.refeshStatus.url}")
    private String url;
     ...
     * @param restTemplate
     */
    public VersionStatusUpdateRemote(RestTemplate restTemplate) {
        super(restTemplate);
    }
     ...
     * @return
     */
    public BusiParamDto versionUpdateParam(Long unitId,String curVersion,String errorInfo){
    ...
    public String executeCall(String url, HttpMethod method, HttpEntity requestEntity, Map<String, Object> maps) throws URISyntaxException {
        ...
        if (exchange.getStatusCode().is2xxSuccessful()) {
            ...
            log.info("调用版本状态接口返回参数：{}", result);
        } else {
            log.error("调用版本状态接口错误");
        }
        return "";
    }

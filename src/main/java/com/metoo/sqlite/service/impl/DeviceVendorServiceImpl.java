...
public class DeviceVendorServiceImpl implements IDeviceVendorService {
    ...
    @Override
    public DeviceVendor selectObjById(Integer id) {
        return this.deviceVendorMapper.selectObjById(id);
    }

    @Override
    public List<DeviceVendor> selectObjByMap(Map params) {
        return this.deviceVendorMapper.selectObjByMap(params);
    }
}
